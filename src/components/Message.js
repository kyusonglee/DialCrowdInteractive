    ...
    render() {
        return <div className="messageContainer" style={{ ...this.props.style }}>
            <div 
			    ...
			    {this.props.received && !((typeof this.props.text) == "string") ? <span className="messageText">{JSON.parse(this.props.text)["value"]}</span>: <span className="messageText">{this.props.text}</span>}
